...
Try to create a flow for the code where the parent function contains all children as a control group. Here is the [Enrichment Task Flow](https://github.com/Shubham-leo/Enrichment_doc_demo/blob/master/Guidelines.md#data-privacy) and the [Flow chart for enrichment](https://github.com/Shubham-leo/Enrichment_doc_demo/blob/master/Guidelines.md#13-create-flow-for-later-use) of enrichment as an example.
